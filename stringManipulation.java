  ...
  public static void main(String[] args)
{
   ...
   System.out.println("Enter the 1st string:");
    ...
    System.out.println("The length of 1st string is: " +str1.length());
    System.out.println("The length of 2nd string is: " +str2.length());
   String join = str1.concat(str2);
    System.out.println("After Joined String is: " + join);
     char c=str2.charAt(3);
      System.out.println("The 4th character of "+str2+" is "+c);
     if(str1.equals(str2))
     {
